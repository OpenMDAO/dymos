...
class ODEIntegrationComp(om.ExplicitComponent):
    ...
    standalone_mode : bool
        ...
        DirectShootingPhase, this system needs to be setup during the Phase configure process and setting this
    ...
    **kwargs : dict
    ...
    theta:  U+03B8
    """
    def __init__(self, input_grid_data, time_options, state_options,
                 output_grid_data=None, parameter_options=None, control_options=None,
                 polynomial_control_options=None,
                 reports=False, standalone_mode=True, **kwargs):
    ...
    def _configure_time(self):
        ...
        configure time in the parent DirectShooting transcription object.
        """
