...
class TestPathConstraintComp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        path_comp.add_path_constraint('a', var_class='ode', shape=(1,),
                                      lower=0, upper=10, units='m')
        path_comp.add_path_constraint('b', var_class='input_control', shape=(3,),
                                      lower=0, upper=10, units='s')
        path_comp.add_path_constraint('c', var_class='control_rate2', shape=(3, 3),
