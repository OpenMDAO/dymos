...
class AnalyticStatesComp(ExplicitComponent):
    ...
    **kwargs : dict
    ...
    def add_state(self, name, val=1.0, shape=None, output_name=None, src_indices=None, flat_src_indices=None,
        ...
        i_meta = self.add_input(name=f'initial_states:{name}', val=in_val, shape=_shape, units=units, desc=desc,
        ...
        self.declare_partials(of=_out_name, wrt=f'initial_states:{name}', rows=ar, cols=ar, val=1.0)
