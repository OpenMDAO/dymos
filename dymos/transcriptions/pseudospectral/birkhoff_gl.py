...
from ..grid_data import GaussLobattoGrid, RadauGrid, BirkhoffGaussLobattoGrid
...
class BirkhoffGL(PseudospectralBase):
    def __init__(self, **kwargs):
        super(BirkhoffGL, self).__init__(**kwargs)
    ...
    def initialize(self):
        ...
        """
        self.options.declare('grid', types=(GaussLobattoGrid, RadauGrid, BirkhoffGaussLobattoGrid, str), allow_none=True, default=None,
    ...
    def configure_time(self, phase):
        ...
        """
        super(BirkhoffGL, self).configure_time(phase)
    ...
    def setup_states(self, phase):
        ...
        phase : dymos.Phase
            The phase object to which this transcription instance applies.
        """
        super(BirkhoffGL, self).setup_states(phase)
    ...
    def configure_states(self, phase):
        ...
        super(BirkhoffGL, self).configure_states(phase)
    ...
    def configure_controls(self, phase):
        ...
        phase : dymos.Phase
            The phase object to which this transcription instance applies.
        """
        super(BirkhoffGL, self).configure_controls(phase)
    ...
    def configure_polynomial_controls(self, phase):
        ...
        phase : dymos.Phase
            The phase object to which this transcription instance applies.
        """
        super(BirkhoffGL, self).configure_polynomial_controls(phase)
    ...
    def setup_ode(self, phase):
        ...
        phase : dymos.Phase
            The phase object to which this transcription instance applies.
        """
        super(BirkhoffGL, self).setup_ode(phase)
    ...
    def setup_defects(self, phase):
        ...
        phase : dymos.Phase
            The phase object to which this transcription instance applies.
        """
        super(BirkhoffGL, self).setup_defects(phase)
    ...
    def configure_defects(self, phase):
        ...
        phase : dymos.Phase
            The phase object to which this transcription instance applies.
        """
        super(BirkhoffGL, self).configure_defects(phase)
