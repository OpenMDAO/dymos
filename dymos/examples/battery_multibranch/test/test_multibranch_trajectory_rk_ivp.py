...
class TestBatteryRKIVP(unittest.TestCase):
    ...
    def test_dynamic_params(self):
        ...
        phase0.add_parameter('P_demand', val=P_DEMAND, units='W')
        ...
        phase1.add_parameter('P_demand', val=P_DEMAND, units='W')
        ...
        phase1_bfail.add_parameter('P_demand', val=P_DEMAND, units='W')
        ...
        phase1_mfail.add_parameter('P_demand', val=P_DEMAND, units='W')
