...
from dymos.examples.aircraft_steady_flight.aero.interpND_aero_coef_comp import \
    setup_surrogates_all, InterpNDAeroCoeffComp
...
class TestAeroCoefComp(unittest.TestCase):
    ...
    def test_aero_coefs(self):
        ...
        prob.model.add_subsystem(name='alpha_ivc',
                                 subsys=om.IndepVarComp('alpha', val=np.zeros(NUM_NODES),
                                                        units='rad'),
                                 promotes=['alpha'])
