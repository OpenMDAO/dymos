...
class CarODE(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, jacobian):
        ...
        jacobian['lambdadot','lambda'] = 2.0*lamb*omega + (V*(0.5*CdA*rho))/M - (1.0*(S_all - 1.0*F_front*delta))/(M*V)
        ...
        jacobian['lambdadot','V'] = (0.5*CdA*lamb*rho)/M + (F_all + S_front*delta + S_all*lamb - F_front*delta*lamb)/(M*V**2)
