...
def two_phase_cannonball_problem(transcription='radau-ps', optimizer='SLSQP',
    ...
    p.set_val('traj.ascent.states:gam', ascent.interpolate(ys=[25, 0], nodes='state_input'), units='deg')
    ...
    plt.plot(exp_out_loaded.get_values('r')['ascent'], exp_out_loaded.get_values('h')['ascent'], 'm--')
    plt.plot(exp_out_loaded.get_values('r')['descent'], exp_out_loaded.get_values('h')['descent'], 'c--')
    ...
    plt.plot(exp_out_loaded.get_values('time')['ascent'], exp_out_loaded.get_values('mass')['ascent'], 'b--')
    plt.plot(exp_out_loaded.get_values('time')['descent'], exp_out_loaded.get_values('mass')['descent'], 'r--')

    plt.figure()

    plt.suptitle('Kinetic Energy vs Time')

    plt.plot(traj.get_values('time')['ascent'], traj.get_values('kinetic_energy.ke')['ascent'], 'bo')
    plt.plot(traj.get_values('time')['descent'], traj.get_values('kinetic_energy.ke')['descent'], 'ro')

    plt.plot(exp_out.get_values('time')['ascent'], exp_out.get_values('kinetic_energy.ke')['ascent'], 'b--')
    plt.plot(exp_out.get_values('time')['descent'], exp_out.get_values('kinetic_energy.ke')['descent'], 'r--')

    plt.plot(exp_out_loaded.get_values('time')['ascent'], exp_out_loaded.get_values('kinetic_energy.ke')['ascent'], 'b--')
    plt.plot(exp_out_loaded.get_values('time')['descent'], exp_out_loaded.get_values('kinetic_energy.ke')['descent'], 'r--')

    plt.figure()

    plt.plot(traj.get_values('time')['ascent'], traj.get_values('gam', units='deg')['ascent'], 'bo')
    plt.plot(traj.get_values('time')['descent'], traj.get_values('gam', units='deg')['descent'], 'ro')
