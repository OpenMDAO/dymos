...
class BrachistochroneVectorStatesODE(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output('pos_dot', val=np.zeros((nn, 2, 2)), desc='velocity components', units='m/s')
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['pos_dot'][:, 0, 0] = v * sin_theta
        outputs['pos_dot'][:, 0, 1] = -v * cos_theta

        outputs['pos_dot'][:, 1, 0] = v * sin_theta
        outputs['pos_dot'][:, 1, 1] = -v * cos_theta
...
phase.add_state('pos',
                ...
                fix_initial=True, fix_final=True, shape=(2, 2))
#
phase.add_state('v',
