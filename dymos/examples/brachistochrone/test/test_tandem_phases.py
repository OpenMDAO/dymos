...
class TestTandemPhases(unittest.TestCase):
    ...
    def _run_transcription(self, transcription):
        ...
        phase0.set_state_options('x', fix_initial=True, fix_final=False,
                                 rate_source=BrachistochroneODE.states['x']['rate_source'],
                                 units=BrachistochroneODE.states['x']['units'])
        phase0.set_state_options('y', fix_initial=True, fix_final=False,
                                 rate_source=BrachistochroneODE.states['y']['rate_source'],
                                 units=BrachistochroneODE.states['y']['units'])
        phase0.set_state_options('v', fix_initial=True,
