...
from dymos.transcriptions import GaussLobatto

SHOW_PLOTS = True


def brachistochrone_min_time(num_segments=8, transcription_order=3,
...
if __name__ == '__main__':
    brachistochrone_min_time(num_segments=40, run_driver=True,
