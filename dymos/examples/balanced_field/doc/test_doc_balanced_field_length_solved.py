    ...
    def test_balanced_field_length_solved(self):
        ...
        for ODE in (BalancedFieldODEComp, BalancedFieldJaxODEComp):
            ...
            with self.subTest(msg='{ODE=}'):
                ...
                tx = dm.PicardShooting(num_segments=1, nodes_per_seg=NODES_PER_SEG)
                vef_to_v1 = dm.Phase(ode_class=ODE, transcription=tx,
                                     ode_init_kwargs={'mode': 'runway',
                                                      'attitude_input': 'pitch',
                                                      'control': 'gam_rate'})
                ...
                tx = dm.PicardShooting(num_segments=1, nodes_per_seg=NODES_PER_SEG)
                rto = dm.Phase(ode_class=ODE, transcription=tx,
                               ode_init_kwargs={'mode': 'runway',
                                                'attitude_input': 'pitch',
                                                'control': 'gam_rate'})
                ...
                tx = dm.PicardShooting(num_segments=1, nodes_per_seg=NODES_PER_SEG)
                v1_to_vr = dm.Phase(ode_class=ODE, transcription=tx,
                                    ode_init_kwargs={'mode': 'runway',
                                                     'attitude_input': 'pitch',
                                                     'control': 'gam_rate'})
                ...
                tx = dm.PicardShooting(num_segments=1, nodes_per_seg=NODES_PER_SEG)
                rotate = dm.Phase(ode_class=ODE, transcription=tx,
                                  ode_init_kwargs={'mode': 'runway',
                                                   'attitude_input': 'pitch',
                                                   'control': 'gam_rate'})
                ...
                tx = dm.PicardShooting(num_segments=1, nodes_per_seg=NODES_PER_SEG)
                liftoff_to_climb_gradient = dm.Phase(ode_class=ODE, transcription=tx,
                                                     ode_init_kwargs={'mode': 'runway',
                                                                      'attitude_input': 'pitch',
                                                                      'control': 'attitude'})
                ...
                tx = dm.PicardShooting(num_segments=1, nodes_per_seg=NODES_PER_SEG)
                climb_to_obstacle_clearance = dm.Phase(ode_class=ODE, transcription=tx,
                                                       ode_init_kwargs={'mode': 'runway',
                                                                        'attitude_input': 'pitch',
                                                                        'control': 'gam_rate'})
