...
class TestTwoBurnOrbitRaiseLinkages(unittest.TestCase):
    ...
    def test_two_burn_orbit_raise_gl_radau_gl_constrained(self):
        ...
        p.set_val('traj.burn2.states:r', value=burn2.interp('r', [1.8, 3]))
        p.set_val('traj.burn2.states:theta', value=burn2.interp('theta', [3.2, 4.0]))
        p.set_val('traj.burn2.states:vr', value=burn2.interp('vr', [.5, 0]))
