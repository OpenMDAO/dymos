...
Table values for -50,000 ft altitude are used for table interpolation
and preventing NANs when running off the end of the table.
Thes values are not considered realistic.
"""
...
# units='ft'
USatm1976Data.alt = np.array([-50000, -1000, 0, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000,
...
# units='degR'
USatm1976Data.T = np.array([522.236, 522.236, 518.67, 515.104, 511.538, 507.972, 504.405, 500.839, 497.273,
...
# units='psi'
USatm1976Data.P = np.array([15.2348, 15.2348, 14.6959, 14.1726, 13.6644, 13.1711, 12.6923, 12.2277, 11.777,
...
# units='slug/ft**3'
USatm1976Data.rho = np.array([0.00244752, 0.00244752, 0.00237717, 0.00230839, 0.00224114, 0.00217539,
...
# units='ft/s'
USatm1976Data.a = np.array([1120.28, 1120.28, 1116.45, 1112.61, 1108.75, 1104.88, 1100.99, 1097.09, 1093.18,
...
# units='lbf*s/ft**2'
USatm1976Data.viscosity = np.array([3.81E-07,
                                    3.81E-07, 3.78E-07, 3.76E-07, 3.74E-07, 3.72E-07, 3.70E-07,
