...
from dymos.models.atmosphere.standard_atmosphere_group import StandardAtmosphereGroup
...
class TestAtmosphere(unittest.TestCase):
    ...
    def test_temperature_comp(self):
        ...
        ivc.add_output(name='alt_m', val=np.ones(n), units='m')

        p.model.add_subsystem('atmos', subsys=USatm1976Comp(num_nodes=n))
        # p.model.add_subsystem('atmos_std', subsys=StandardAtmosphereGroup(num_nodes=n))
        ...
        print(p.get_val('atmos.sos', units='ft/s'), p.get_val('atmos_std.sos', units='ft/s'))
        print(p.get_val('atmos.pres', units='psi'), p.get_val('atmos_std.pres', units='psi'))
        print(p.get_val('atmos.rho', units='slug/ft**3'), p.get_val('atmos_std.rho', units='slug/ft**3'))
        print(p.get_val('atmos.temp', units='degR'), p.get_val('atmos_std.temp', units='degR'))
        exit(0)
