...
class TestControlRateComp(unittest.TestCase):
    ...
    @parameterized.expand(
        itertools.product(['gauss-lobatto', 'radau-ps'],  # transcription
                          ...
                          ), testcase_func_name=lambda f, n, p: '_'.join(['test_control_interp_scalar',
                                                                          p.args[0],
                                                                          str(p.args[1])])
    )
    ...
    @parameterized.expand(
        itertools.product(['gauss-lobatto', 'radau-ps'],  # transcription
                          [True, False],  # compressed
                          ), testcase_func_name=lambda f, n, p: '_'.join(['test_control_interp_vector',
                                                                          p.args[0],
                                                                          str(p.args[1])])
    )
    ...
    @parameterized.expand(
        itertools.product(['gauss-lobatto', 'radau-ps'],  # transcription
                          [True, False],  # compressed
                          ), testcase_func_name=lambda f, n, p: '_'.join(['test_control_interp_matrix_3x1',
                                                                          p.args[0],
                                                                          str(p.args[1])])
    )
    ...
    @parameterized.expand(
        itertools.product(['gauss-lobatto', 'radau-ps'],  # transcription
                          [True, False],  # compressed
                          ), testcase_func_name=lambda f, n, p: '_'.join(['test_control_interp_matrix_2x2',
                                                                          p.args[0],
                                                                          str(p.args[1])])
    )
    ...
    #                                                    time_units='s'))
    #
    #     p.model.connect('controls:a', 'control_interp_comp.controls:a')
    #     p.model.connect('controls:b', 'control_interp_comp.controls:b')
    #     p.model.connect('dt_dstau', 'control_interp_comp.dt_dstau')
    #
    #     p.setup(force_alloc_complex=True)
    #
    ...
    #
    #     t = p['time']
    #     control_disc_idxs = gd.subset_node_indices['control_disc']
    #     p['controls:a'] = f_a(t)[control_disc_idxs]
    #     p['controls:b'] = f_b(t)[control_disc_idxs]
    #
    #     p.run_model()
    #
    #     a_value_expected = f_a(t)
    ...
    #                         np.atleast_2d(a_value_expected).T)
    #
    #     print(p['control_interp_comp.control_values:b'])
    #     print(np.atleast_2d(b_value_expected).T)
    #
    #     assert_almost_equal(p['control_interp_comp.control_values:b'],
    #                         np.atleast_2d(b_value_expected).T)
    #
    ...
    #     t = p['time']
    #     control_disc_idxs = gd.subset_node_indices['control_disc']
    #     p['controls:a'][:, 0] = f_a(t)[control_disc_idxs]
    #     p['controls:a'][:, 1] = f_b(t)[control_disc_idxs]
    #     p['controls:a'][:, 2] = f_c(t)[control_disc_idxs]
    #
    #     p.run_model()
    #
    #     a0_val_expected = f_a(t)
    #     a1_val_expected = f_b(t)
    #     a2_val_expected = f_c(t)
    #
    #     a0_rate_expected = f1_a(t)
    #     a1_rate_expected = f1_b(t)
    #     a2_rate_expected = f1_c(t)
    ...
    #     t = p['time']
    #     control_disc_idxs = gd.subset_node_indices['control_disc']
    #     p['controls:a'][:, 0, 0] = f_a(t)[control_disc_idxs]
    #     p['controls:a'][:, 1, 0] = f_b(t)[control_disc_idxs]
    #     p['controls:a'][:, 2, 0] = f_c(t)[control_disc_idxs]
    #
    #     p.run_model()
    #
    #     a0_val_expected = f_a(t)
    ...
    #     control_disc_idxs = gd.subset_node_indices['control_disc']
    #     p['controls:a'][:, 0, 0] = f_a(t)[control_disc_idxs]
    #     p['controls:a'][:, 0, 1] = f_b(t)[control_disc_idxs]
    #     p['controls:a'][:, 1, 0] = f_c(t)[control_disc_idxs]
    #     p['controls:a'][:, 1, 1] = f_d(t)[control_disc_idxs]
    #
    #     p.run_model()
    #
    #     a0_val_expected = f_a(t)
