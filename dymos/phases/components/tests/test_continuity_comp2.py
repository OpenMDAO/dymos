...
from dymos.phases.components.continuity_comp2 import ContinuityComp2
...
class TestContinuityComp2(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cnty_comp = ContinuityComp2(grid_data=gd, time_units='s',
        ...
        disc_subidxs = ([i for (i, val) in enumerate(gd.subset_node_indices['state_disc'])
                         if val in gd.subset_node_indices['segment_ends']])
