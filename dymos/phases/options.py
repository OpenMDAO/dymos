...
class StateOptionsDictionary(OptionsDictionary):
    ...
    def __init__(self, read_only=False):
        ...
        self.declare(name='solve_continuity', default=False, types=bool,
                     desc='setting to control if inter-segment state continuity defects are '
                          'solved with a newton solver')

        self.declare(name='propagation', default='forward', values=('forward', 'backward'),
        ...
        self.declare(name='connect_initial', default=False, types=bool,
                     desc='Whether an input is created to pass in the initial state. This may be '
                          'set by a trajectory that links phases.')

        self.declare(name='connect_final', default=False, types=bool,
                     desc='Whether an input is created to pass in the initial state. This may be '
                          'set by a trajectory that links phases.')
