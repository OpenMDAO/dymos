...
class TestExplicitPhaseNLRK(unittest.TestCase):
    ...
    def test_single_segment_simple_integration(self):
        ...
        # print(p.get_val('phase0.ode.t'))
        # print(p.get_val('phase0.ode.ydot'))
        # print(p.get_val('phase0.timeseries.state_rate:y'))
        # # from openmdao.api import view_model
        # # view_model(p.model)
        #
        # import matplotlib.pyplot as plt
        # plt.plot(p['phase0.timeseries.time'], p['phase0.timeseries.states:y'], 'ro')
        # plt.plot(p['phase0.timeseries.time'], p['phase0.timeseries.state_rate:y'], 'b-')
        # plt.show()
