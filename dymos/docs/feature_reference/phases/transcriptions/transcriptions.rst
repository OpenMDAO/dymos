...
Dymos implements several different *transcriptions* which are used to convert a continuous
optimal control problem into an analogous nonlinear programming (NLP) problem.

Dymos implements multi-phase trajectory optimization.  That is to say, in each phase
...
Different transcription methods are supported via different Phase types in Dymos.  Currently,
