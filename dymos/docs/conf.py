# -*- coding: utf-8 -*-
#
# dymos documentation build configuration file, created by
...
project = u'dymos'
copyright = u'2017, National Aeronautics and Space Administration'
author = u'Rob Falck and John Hwang'
...
latex_documents = [
    (master_doc, 'dymos.tex', u'Dymos Documentation',
     u'Rob Falck', 'manual'),
]
...
man_pages = [
    (master_doc, 'dymos', u'Dymos Documentation',
     [author], 1)
]
