...
from openmdoc.phases.optimizer_based.components import CollocationComp
from openmdoc.phases.optimizer_based.components import StateInterpComp
from openmdoc.phases.components import ContinuityComp
from openmdoc.phases.phase_base import PhaseBase
from openmdoc.utils.interpolate import LagrangeBarycentricInterpolant, StaticInterpolant
from openmdoc.utils.misc import CoerceDesvar
from openmdoc.utils.ode_integrator import ODEIntegrator, StdOutObserver, SimulationResults, \
    ProgressBarObserver
...
class OptimizerBasedPhaseBase(PhaseBase):
    ...
    def simulate(self, times='all', integrator='vode', integrator_params=None,
                 observer=None, direction='forward'):
        """
